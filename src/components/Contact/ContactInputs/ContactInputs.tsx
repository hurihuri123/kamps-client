...
export default class ContactInputs extends React.Component<Props, IState> {
	...
	render() {
		...
		return (
			<div className={`contact-inputs-contaienr`}>
				<CustomSelector
					value={optionSelected}
					error={this.state.optionSelectedError}
					placeholder={Lang.format('ContactCustomWhichIssuse')}
				...
				<CustomInputText
					...
					placeholder={Lang.format('ContactCustomerInputFullName')}
				...
				<CustomInputText
					...
					placeholder={Lang.format('ContactCustomerPhoneNumber')}
				...
				<CustomTextArea
					...
					placeholder={Lang.format('HowCantIHelpYou')}
				/>

				<CustomButton
					onClick={this.sendMessageClicked}
					text={Lang.format('SendMessage')}
					color={'gray'}
				/>
			</div>
		);
